 ...
 *@NModuleScope Public
 */
 define(["N/url", "../libs/customscript_ext_util"], function (url, EXTEND_UTIL) {
    var exports = {};
    ...
    exports.saveRecord = function (context) {
      ...
      const planCount = objCurrentRec.getLineCount({
    ...
    function _handleSelectInput(context) {
      var objCurrentRec = context.currentRecord;
      var stLineIndex = objCurrentRec.getCurrentSublistIndex({
        sublistId: "custpage_plans",
      });
      var stLineCount = objCurrentRec.getLineCount({
        sublistId: "custpage_plans",
      });
      var bTrue = objCurrentRec.getCurrentSublistValue({
        sublistId: "custpage_plans",
        fieldId: "custpage_select",
      });
